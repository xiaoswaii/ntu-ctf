...
public final class UStringsKt {
    ...
    public static final String m950toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m952toStringolVBNx4(short s, int i) {
    ...
    public static final String m951toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m949toStringJSWoG40(long j, int i) {
